	...
	<div class="confighome">
		...
		<div class="operation">
			...
			<div class="operationBox">
				<input type="text" id="item-name" placeholder="模板名" class="manage-input" v-model="searchData.name">
				<i class="el-icon-search" @click="searchMechine"></i>
				...
				<table class="manage-table">
					...
					<tbody>
						<tr v-for="(item,index) in templateList">
							<td><i class="el-icon-arrow-down"></i></td>
